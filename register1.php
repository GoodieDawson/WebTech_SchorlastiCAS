...
<head>
  <title>test</title>
    ...
    <!--<link rel = "stylesheet" type = "text/js" href = "register1.js"/>-->
    <!-- Font Awesome -->
...
<body style="background-image: url(image/road_marking_bridge_123398_1280x720.jpg); background-repeat: no-repeat; background-size: cover">
<header>
          <!-- Navbar -->
